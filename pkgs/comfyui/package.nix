...
let
  ...
  config-data = {
    comfyui = {
      ...
      diffusers = "${modelsPath}/diffusers";
      loras = "${modelsPath}/loras";
      upscale_models = "${modelsPath}/upscale_models";
      vae = "${modelsPath}/vae";
      vae_approx = "${modelsPath}/vae_approx";
      gligen = "${modelsPath}/gligen";
      custom_nodes = "${modelsPath}/custom_nodes";
      hypernetworks = "${modelsPath}/hypernetworks";
      photomaker = "${modelsPath}/photomaker";
      classifiers = "${modelsPath}/classifiers";
    };
  };
...
in stdenv.mkDerivation rec {
  ...
  installPhase = ''
    ...
    echo "Setting up custom nodes folder from ${customNodesCollection} to $out/custom_nodes"
