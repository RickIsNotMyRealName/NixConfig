# # TODO when this module gets moved from unstable to stable this module will be unessasary
# https://github.com/NixOS/nixpkgs/blob/nixos-unstable/nixos/modules/programs/nh.nix
{ config
, lib
, pkgs
, ...
